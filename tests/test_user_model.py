...
class TestUserModel:
    def test_user_creation(self, init_database, sample_users):
    ...
    def test_password_hash_uniqueness(self, init_database):
        ...
        When:  Both users are assigned the same plaintext
        password and persisted.
    ...
    def test_uuid_uniqueness(self, sample_users):
    ...
    def test_updated_on_field(self, init_database, sample_users):
    ...
    def test_user_repr(self, sample_users):
        ...
        expected format is returned, containing the username 
    ...
    def test_user_deletion(self, init_database, sample_users):
        """Verify user deletion functionality.

        Given: Two sample users in the database.
        When:  Both users are deleted from the database and changes 
        are committed.
